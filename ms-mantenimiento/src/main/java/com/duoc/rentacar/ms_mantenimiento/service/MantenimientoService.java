...
public class MantenimientoService {
    ...
    public Mantenimiento actualizar(Long id, Mantenimiento mantenimiento)
    {
        ...
        existente.setFecha_ingreso(mantenimiento.getFecha_ingreso());
        existente.setFecha_salida(mantenimiento.getFecha_salida());
        existente.setCosto_reparacion(mantenimiento.getCosto_reparacion());
        existente.setPatente_auto_ref(mantenimiento.getPatente_auto_ref());
